...
class RosbagProcessor(Node):
    def __init__(self):
        ...
        self.declare_parameter('bags_directory',
                               str(Path.home()) + '/robotervermessung-rosbag-recorder/data/rosbag_data')
        ...
        self.declare_parameter('merged_output_directory',
                               str(Path.home()) + '/robotervermessung-rosbag-recorder/data/csv_data/')
